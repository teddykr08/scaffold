-- =================================================================
-- CLEANUP SCRIPT: REMOVE "ADDITIONAL INSTRUCTIONS"
-- =================================================================
-- Run this script in your Supabase SQL Editor to:
-- 1. Remove the legacy field from any existing apps
-- 2. Update the trigger so it doesn't appear for new users
-- =================================================================

-- 1. Delete the field from existing records
DELETE FROM task_fields WHERE field_label = 'Additional Instructions';

-- 2. Update the function (Prevent it from coming back)
